...
import com.example.dacn2.service.entity.RoleService;
...
public class AdminRoleController {
    ...
    public ApiResponse<Role> addPermissionToRole(@PathVariable Long roleID,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ApiResponse<Role> removePermissions(@PathVariable Long roleId,
            @RequestBody AssignPermissionRequest request) {
